...
\begin{frame}
    \frametitle{Oplossing \#1: Switch op Type}
...
\begin{frame}
    \frametitle{Oplossing \#2: Visitor Design Pattern}
...
\begin{frame}
    \frametitle{Oplossing \#3: Discriminated Unions}
