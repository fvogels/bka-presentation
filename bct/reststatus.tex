...
\begin{frame}
    \frametitle{Poging \#1: Switchen op Type}
    \lstinputlisting[language=TypeScript]{bct/instanceof.ts}
    \begin{itemize}
        \item Fragiel
            \begin{itemize}
                \item Typo's
                \item Rename refactoring zou mislopen
                \item Wat met minification?
            \end{itemize}
...
\begin{frame}
    \frametitle{Poging \#2: Manuele Type Switch}
    \lstinputlisting[language=TypeScript]{bct/typeswitch.ts}
    \begin{itemize}
        \item Geen exhaustiviteitscheck
        \item Strings kunnen mistypt worden
    \end{itemize}
\end{frame}

\begin{frame}
    \frametitle{Poging \#3: Visitor Design Pattern}
...
\begin{frame}
    \frametitle{Uiteindelijke Keuze: Discriminated Unions}
