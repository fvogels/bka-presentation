...
\begin{frame}
    ...
    \structure{Oplossing}
    \begin{itemize}
        \item Website \href{https://bct-sales.myaddr.io}{https://bct-sales.myaddr.io}
...
\begin{frame}
    \frametitle{V\'o\'or de verkoopdag}
    \begin{itemize}
        \item Sellers registreren hun artikels via website
...
\begin{frame}
    \frametitle{Op de verkoopdag}
    \begin{itemize}
        \item Cashiers gebruiken website om verkopen te registreren
            \begin{itemize}
        ...
        \item Admin ziet verkoopcijfers in realtime
        \item Admin kan correcties uitvoeren
    \end{itemize}
\end{frame}

\begin{frame}
    \frametitle{Na de verkoopdag}
    \begin{itemize}
        \item Admin vraagt verkochte artikels op
        \item Exporteert data in CSV formaat
        \item Rapporten worden opgesteld
        \item Verkoopsopbrengst wordt gestort naar sellers
    \end{itemize}
\end{frame}
