...
\begin{frame}
    ...
    \begin{itemize}
        \item TUI voor admins (work in progress)
        \item Scheiding domainlaag en presentatielaag
            \begin{itemize}
        ...
        \item Robuust
            \begin{itemize}
                \item Bugbestendig design
                \item Declaratieve stijl
            \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \node[anchor=south west,font={\sc\tiny}] at (0,0) {Presentatielaag};
            \node[anchor=north west,font={\sc\tiny}] at (0,0) {Domeinlaag};

            \node[anchor=north,font=\tiny,rectangle split,rectangle split parts=2,draw,inner sep=2pt] (item) at (4, -0.25) {
                \textbf{Item}
                \nodepart{two}
                \begin{tabular}{ll}
            ...
            \node[anchor=south] at (4,0.25) { \includegraphics[height=3cm]{images/presentation.png} };
        \end{tikzpicture}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Pull i.p.v.~push als oplossing
    \end{itemize}
\end{frame}
