...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item[\advantage] Vrije keuze qua gebruikte technologie
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item[\disadvantage] Vergt installatie en updates per machine
        \item[\disadvantage] Niet mobile friendly
        \item[\disadvantage] Mogelijk platformafhankelijk, naargelang gebruikte technologie
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item[\advantage] Gemakkelijk omzetbaar naar desktop client
        \item[\disadvantage] Vergt browser
        \item[\disadvantage] Vergt hosting
        \item[\disadvantage] Relatief oneffici\"ent
